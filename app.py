...
cursor = conn.cursor()#!C:\Users\Andyr\AppData\Local\Programs\Python\Python311\python.exe
print("Content-Type: text/html\n")
...
def submit():
    ...
    conn = sqlite3.connect('C:\\xampp\\htdocs\\MyWebsite1\\assessment_results.db')
    cursor = conn.cursor()
