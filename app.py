...
def results():
    ...
    # Recommended improvements for the company based on their answers
        ...
        "all": "We recommend requiring password changes at least every 90 days to protect against the risk of brute force attacks and other types of password cracking. Remember to follow the (<a href='https://nvlpubs.nist.gov/nistpubs/SpecialPublications/NIST.SP.800-63-3.pdf'>NIST.SP.800-63-3. 1</a>) guidelines for password complexity and change requirements."
        }
